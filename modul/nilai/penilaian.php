            ...
            <div class="card-body">
              ...
              <form role="form" id="quickForm" class="needs-validation" novalidate action="aksi-penilaian" method="POST">
                ...
                <div class="row mt-4 mb-3">
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio1" name="n1" value="50" class="custom-control-input" required>
                      <label class="custom-control-label" for="customRadio1">50</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio2" name="n1" value="55" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio2">55</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio3" name="n1" value="60" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio3">60</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio4" name="n1" value="65" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio4">65</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio5" name="n1" value="70" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio5">70</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio6" name="n1" value="75" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio6">75</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio7" name="n1" value="80" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio7">80</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio8" name="n1" value="85" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio8">85</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio9" name="n1" value="90" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio9">90</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio10" name="n1" value="95" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio10">95</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio11" name="n1" value="100" class="custom-control-input">
                ...
                <div class="row mt-4 mb-3">
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio12" name="n2" value="50" class="custom-control-input" required>
                      <label class="custom-control-label" for="customRadio12">50</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio13" name="n2" value="55" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio13">55</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio14" name="n2" value="60" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio14">60</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio15" name="n2" value="65" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio15">65</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio16" name="n2" value="70" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio16">70</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio17" name="n2" value="75" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio17">75</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio18" name="n2" value="80" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio18">80</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio19" name="n2" value="85" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio19">85</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio20" name="n2" value="90" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio20">90</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio21" name="n2" value="95" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio21">95</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio22" name="n2" value="100" class="custom-control-input">
                ...
                <div class="row mt-4 mb-3">
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio23" name="n3" value="50" class="custom-control-input" required>
                      <label class="custom-control-label" for="customRadio23">50</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio24" name="n3" value="55" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio24">55</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio25" name="n3" value="60" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio25">60</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio26" name="n3" value="65" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio26">65</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio27" name="n3" value="70" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio27">70</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio28" name="n3" value="75" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio28">75</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio29" name="n3" value="80" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio29">80</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio30" name="n3" value="85" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio30">85</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio31" name="n3" value="90" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio31">90</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio32" name="n3" value="95" class="custom-control-input">
                      <label class="custom-control-label" for="customRadio32">95</label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio33" name="n3" value="100" class="custom-control-input">
