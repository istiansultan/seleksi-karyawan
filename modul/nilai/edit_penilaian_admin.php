...
$data4 = mysqli_query($koneksi, " select * from
                                  master_penilaian
                                  where id_calon='$_GET[nilai]' and penguji='$_GET[penguji]'");
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form role="form" id="quickForm" class="needs-validation" novalidate action="aksi-penilaian" method="POST">
                <input hidden class="input-xlarge focused" name="id_calon" value="<?php echo $peserta['id_calon']; ?>" type="text">
                <input hidden class="input-xlarge focused" name="penguji" value="<?php echo $pes['penguji']; ?>" type="text"></td>
                ...
                <div class="row mt-5 text-center">
                  ...
                  <div class="col">
                    <button type="submit" name="edit" class="btn btn-primary btn-block mr-1">EDIT</button>
                  </div>
                </div>
              </form>
            </div>
